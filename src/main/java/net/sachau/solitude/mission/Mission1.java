...
import net.sachau.solitude.asset.Elevator;
import net.sachau.solitude.asset.Locker;
import net.sachau.solitude.asset.Nest;
...
import net.sachau.solitude.event.Fire;
import net.sachau.solitude.event.Nothing;
import net.sachau.solitude.item.FirstAidKit;
import net.sachau.solitude.model.*;
import net.sachau.solitude.event.CreateEnemyType1;
...
public class Mission1 extends Mission implements Observer {
    ...
    public Mission1() {
        super(Messages.get("missions.mission1"));
    ...
    public void generateMap(GameEngine gameEngine) {
            ...
            for (int x = 0; x < line.length(); x ++) {
                ...
                switch (c) {
                    ...
                    case 'E': {
                        ...
                        elevator.addAsset(new Elevator(), elevator);
                    ...
                    case '#': {
                        ...
                        if (c == 'S') {
                            ...
                            startingPosition.addAsset(new Nest(), startingPosition);
                        } else {
         ...
         */
        startingPosition().addAsset(new Locker(), startingPosition);
        startingPosition().addAsset(new Burning(), startingPosition);
